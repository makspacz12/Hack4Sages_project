"""
Older radiation attenuation model for a uniform spherical rock.

It has no biological core. Kept in the repository as a reference point.
"""
...
def radiation_at_points_in_sphere(
    ...
    """
    Compute the radiation reaching points inside a uniform rock.
    """
