...
PARAMETERS: list[dict[str, Any]] = [
    ...
    {"key": "years", "label": "Simulated time", "type": "float",
     "min": 0.25, "max": 200, "step": 0.25, "default": 2.5, "unit": "yr",
     "help": "Total time to propagate. Frame count is years / step."},
    {"key": "dt", "label": "Time step", "type": "float",
     "min": 0.005, "max": 0.5, "step": 0.005, "default": 0.025, "unit": "yr",
     "help": "One output frame per step. Smaller means smoother and slower."},
