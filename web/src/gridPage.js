...
function injectPlotStyles() {
  ...
  s.textContent = `
    ...
    #grid-plot svg .tick { fill: var(--ink-dim); font-size: 0.625rem; font-family: var(--font-mono); }
    ...
    #grid-plot svg .axis-label { fill: var(--ink-dim); font-size: 0.625rem; font-family: var(--font-mono); }
    #grid-plot .hm-cell { cursor: crosshair; }
    #grid-plot .hm-tooltip {
      position: absolute; pointer-events: none; z-index: 5;
      background: var(--bg-panel); border: 1px solid var(--line-edge);
      border-radius: 5px; padding: 8px 10px; font-family: var(--font-mono);
